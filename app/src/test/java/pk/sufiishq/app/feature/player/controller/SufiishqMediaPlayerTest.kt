...
class SufiishqMediaPlayerTest : SufiIshqTest(), PlayerStateListener {
    ...
    private lateinit var currentMediaState: MediaState
    ...
    fun setUp() {
        ...
        sufiishqMediaPlayer =
            SufiishqMediaPlayer(appContext, mediaPlayer, audioManager, audioFocusRequestBuilder)
    ...
    fun testOnError_shouldSet_errorState() {
        sufiishqMediaPlayer.onError(null, 0, 1)
        assertTrue(currentMediaState is MediaState.Error)
    }

    @Test
    fun testOnAudioFocusChange_toLoss_shouldSet_pauseState() {
        every { mediaPlayer.pause() } returns Unit
    ...
    @Test
    fun testOnAudioFocusChange_toLossTransient_shouldSet_pauseState() {
        every { mediaPlayer.pause() } returns Unit
