...
import pk.sufiishq.app.ui.components.dialogs.MainNavigationDrawer
...
import pk.sufiishq.app.utils.fakeHomeDataProvider
...
fun DashboardView(
    ...
    SIScaffold(
        drawer = {
            MainNavigationDrawer(dashboardDataProvider.getMainNavigationItems())
        },
...
fun LightPreviewDashboardView() {
    AuroraLight {
        DashboardView(
            ...
            homeDataProvider = fakeHomeDataProvider(),
            globalDataProvider = fakeGlobalDataProvider(),
