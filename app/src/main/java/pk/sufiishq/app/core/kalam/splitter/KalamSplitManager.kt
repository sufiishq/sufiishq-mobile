...
class KalamSplitManager @Inject constructor(
    ...
    fun saveSplitKalam(sourceKalam: Kalam, kalamTitle: String) {
        ...
        CoroutineScope(dispatcher).launch {
            ...
            getDestFile()
                .moveTo(appContext.filesDir.appendPath(fileName))
                .also {
    ...
    private fun splitCompleted(splitStatus: SplitStatus) {
        ...
        splitKalamInfo
            ...
            ?.let {
                ...
                val duration = if (splitStatus is SplitStatus.Done) {
                    previewAudioPlayer.getDuration(getDestFile().absolutePath)
                } else it.previewKalamLength
